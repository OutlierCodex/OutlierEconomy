package org.outliertech.outliereconomy.rendering.screens;
...
public class ATMScreen extends Screen{
    ...
    public ATMScreen(Text title, Screen parent) {
        super(title);
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        // x, y, width, height
        ATMWidget atmWidget = new ATMWidget(40, 80, 120, 20);
        this.addDrawableChild(atmWidget);
        // :::3
        // :::1
    }
